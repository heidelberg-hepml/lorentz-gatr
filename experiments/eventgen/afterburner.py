...
# things we do to make GATrCFM win


class AfterBurner(GATrCFM):
    # Abstract afterburner class
    # afterburner = network to modify the transformed velocities
    ...
    def batch_loss(self, x0_fourmomenta, ijet):
        ...
        vp_loss = self.afterburn(vp_loss, xt_loss, vp_network, xt_network)  # NEW LINE
