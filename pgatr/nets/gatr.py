...
from pgatr.layers.gatr_block import GATrBlock
from pgatr.layers.linear import EquiLinear
from pgatr.layers.mlp.config import MLPConfig
from pgatr.utils.tensors import construct_reference_multivector

from experiments.logger import LOGGER

class PGATr(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        LOGGER.info(f"The inschannels is {in_s_channels}")
